...
while True:
    ...
    if not os.path.exists(logfile):
        ...
        print(
            "TEKNIQ: Hey Hey! This file already exists. If you keep going, you will just append to the existing file. Just letting you know."
        )
        break
        ...
        if len(cmd) == 1:
            ...
            if len(cmd) < 5:
                ...
                for place in places:
                    if place.name == cmd[4]:
                        caracters.append(
                            roleplay.Character(cmd[2], cmd[3], cmd[4]))
                        print("Created " + cmd[2].upper() + " the " +
                              cmd[3].upper() + " at " + cmd[4].upper())
                        log("Created a " + cmd[3].upper() + " named " +
                            cmd[2].upper() + " at " + cmd[4].upper())
                        foundPlace = True
                if not foundPlace:
            ...
            for character in caracters:
                if character.name == cmd[1]:
                    ...
                    if character.helditem[1] == "":
                        ...
                        print(
                            "Character has no hands free. use the drop command."
                        )
            if not found:
                print("Character not found")
        elif len(cmd) == 4:
